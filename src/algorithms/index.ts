...
export class BFSAlgorithm implements RouteAlgorithm {
	...
	findShortestPath(start: NodeId, goal: NodeId, options?: GraphTraversalOptions): Promise<PathResult | null> {
...
export class YensAlgorithm implements RouteAlgorithm {
	...
	findKShortestPaths(start: NodeId, goal: NodeId, k: number, options?: GraphTraversalOptions): Promise<PathResult[]> {
